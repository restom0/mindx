...
function Dashboard() {
  ...
  const handleOpen = (id) => {
    setOpen(!open);
    setMovieList(movie.find((e) => e._id === id));
  };
  React.useEffect(() => {
  ...
  function getMovieList() {
    return fetch("http://127.0.0.1:3000/movies")
  ...
  React.useEffect(() => {
    const fetchMovies = async () => {
      setMovie(await getMovieList());
      setOffset(Math.ceil(movie.length / 4));
    };
    ...
    <>
      <Navbar className=" px-4 py-2 lg:px-8 lg:py-4">
        <div className="container mx-auto flex flex-wrap items-center justify-between text-blue-gray-900">
          ...
          >
            Movie <Chip className="inline p-1" color="deep-orange" value="UI" />
          </Typography>
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {movie &&
            movie.slice((active - 1) * 4, active * 4).map((e) => (
              <div key={e._id}>
                <Card
                ...
                >
                  ...
                  <CardFooter className="flex items-center justify-between">
                    ...
                    <div className="flex items-center -space-x-3">
                      <Typography className="font-normal">{e.year}</Typography>
                    </div>
                  </CardFooter>
                </Card>
                {movieList ? (
                    ...
                    <DialogBody>
                      <Card className="w-full max-w-[48rem] flex-row">
                        ...
                        <CardBody>
                          ...
                          >
                            {movieList.time} min - {movieList.year}
                          </Typography>
